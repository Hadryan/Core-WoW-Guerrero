...
#ifndef monsterCORE_GOSSIP_H
#define monsterCORE_GOSSIP_H
...
class PlayerMenu
{
    public:
        ...
        void SendQuestGiverQuestDetails(Quest const* quest, uint64 npcGUID, bool activateAccept, bool p_DisplayPopup = false) const;
