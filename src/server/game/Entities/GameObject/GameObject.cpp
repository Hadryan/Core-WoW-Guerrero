...
void GameObject::Update(uint32 diff)
{
    ...
    switch (m_lootState)
    {
        ...
        case GO_JUST_DEACTIVATED:
        {
			...
			uint32 respawnDelayTime = m_respawnDelayTime;
			if (GetMap())
			{
			...
			if (currentPlayers != -1)
			{
				...
				respawnDelayTime *= (1 - (percentageReduction / 100));
			}

			m_respawnTime = time(NULL) + respawnDelayTime;
...
void GameObject::Use(Unit* user)
{
    ...
    switch (GetGoType())
    {
        ...
        case GAMEOBJECT_TYPE_GOOBER:                        //10
        {
            ...
            if (Player* player = user->ToPlayer())
            {
                ...
                if (info->goober.eventId)
                {
                    ...
                    GetMap()->ScriptsStart(SmartScriptType::SMART_SCRIPT_TYPE_EVENT, info->goober.eventId, player, this);
        ...
        case GAMEOBJECT_TYPE_CAMERA:                        //13
        {
            ...
            {
                GetMap()->ScriptsStart(SmartScriptType::SMART_SCRIPT_TYPE_EVENT, info->camera.eventID, player, this);
