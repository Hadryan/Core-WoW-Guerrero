...
#ifndef monster_LOOTMGR_H
#define monster_LOOTMGR_H
...
{
    int32  itemid;                                          // id of the item, values < 0 == currency
...
struct Loot
{
    ...
    std::list<std::pair<int, int>> currencies;
    ...
    // Inserts the currency into the loot (called by LootTemplate processors)
    void AddCurrency(int32 currencyId, LootStoreItem const& item);
