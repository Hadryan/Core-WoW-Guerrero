...
void LFGQueue::AddToQueue(uint64 guid, bool reAdd)
{
...
void LFGQueue::AddToFrontCurrentQueue(uint64 guid)
{
...
LfgCompatibility LFGQueue::CheckCompatibility(LfgGuidList check)
{
    ...
    do
    {
        ...
        proposal.dungeonId = monster::Containers::SelectRandomContainerElement(proposalDungeons);
