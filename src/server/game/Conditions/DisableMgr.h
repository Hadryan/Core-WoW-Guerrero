...
#ifndef monster_DISABLEMGR_H
#define monster_DISABLEMGR_H
...
enum DisableType
{
    ...
    DISABLE_TYPE_MMAP_FOR_UNIT_ENTRY    = 9, 
};
...
//enum MMapForUnitDisableTypes
//{
//    MMAP_DISABLE_FOR_UNIT_ENTRY         = 0x0,  // entry = creature_template.entry, flags = 0
//    MMAP_DISABLE_FOR_PETS               = 0x1,  // entry = 0, flags = 1
//    MMAP_DISABLE_FOR_PETS_IN_TRANSPORT  = 0x2,  // entry = 0, flags = 2
//    MMAP_DISABLE_FOR_VEHICLE_IN_WATER   = 0x4,   // entry = 0, flags = 4
//
//    MMAP_MAX_DISABLE_FLAGS              = (MMAP_DISABLE_FOR_PETS | MMAP_DISABLE_FOR_PETS_IN_TRANSPORT | MMAP_DISABLE_FOR_VEHICLE_IN_WATER)
//};
