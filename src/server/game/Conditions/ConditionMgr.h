...
#ifndef monster_CONDITIONMGR_H
#define monster_CONDITIONMGR_H
...
{                                                           // value1           value2         value3
	...
	CONDITION_IN_WATER              = 39,                   // 0                0              0                  true if unit in water
    CONDITION_QUEST_STATUS          = 106,                  ///< QuestID        StatusMask     0                  true if player has that quest status & mask

    CONDITION_HAS_SPELL_COOLDOWN    = 150,
    CONDITION_MAX,
};
