...
void WaypointMgr::Load()
{
    ...
    QueryResult result = WorldDatabase.Query("SELECT id, point, position_x, position_y, position_z, orientation, move_type, delay, action, action_chance, inverse_formation_angle FROM waypoint_data ORDER BY id, point");
