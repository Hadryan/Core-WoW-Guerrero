...
namespace Movement
{
    ...
    public:
        ...
        explicit MoveSplineInit(Unit* m, uint32 p_OverrideSplineId = 0);
    ...
    inline void MoveSplineInit::SetSwim(bool p_Enable) { args.flags.canSwim = p_Enable; }
