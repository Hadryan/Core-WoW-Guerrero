...
enum WorldBoolConfigs
{
    ...
    CONFIG_DISCORD_LOG,
    CONFIG_BONUS_XP_PVP_ENABLE,
    CONFIG_BONUS_XP_DUNGEON_ENABLE,
    CONFIG_BONUS_TITLE_REQUIREMENT,
    /// Grids
...
enum Rates
{
    ...
    RATE_XP_EXPLORE,
    RATE_REPAIRCOST,
    RATE_BONUS_XP_PVP_VALUE,
    RATE_BONUS_XP_DUNGEON_VALUE,
...
class World
{
    public:
		...
		uint64 GetRetailDelayTickCount();
		std::vector<Unit*> m_unitsRequiringVisibilityUpdates;
