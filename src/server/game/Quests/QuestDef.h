...
#ifndef monsterCORE_QUEST_H
#define monsterCORE_QUEST_H
...
enum __QuestSpecialFlags
{
    ...
    // monster flags for set SpecialFlags in DB if required but used only at server
...
class Quest
{
    ...
    public:
        ...
        bool   IsAutoTake(Object* questGiver = nullptr, uint64 guid = 0) const;
