...
#ifndef monster_CREATUREAI_H
#define monster_CREATUREAI_H
...
class CreatureAI : public UnitAI
{
    ...
    public:
        ...
        explicit CreatureAI(Creature* creature) : UnitAI(creature), me(creature), m_MoveInLineOfSight_locked(false), m_ignoreEvade(false) {}
		...
		void IgnoreEvade(bool value) { m_ignoreEvade = value; }

		bool IsIgnoringEvade() const { return m_ignoreEvade; }

        ///New Actions

        /// OnAuraApplied - When Unit gets aura applied
        /// @p_SpellID - SpellID of Aura
        virtual void OnAuraApplied(uint32 p_SpellID) { }

        /// OnAuraApplied - When Unit gets aura removed
        /// @p_SpellID - SpellID of Aura
        virtual void OnAuraRemoved(uint32 p_SpellID) { }

        virtual bool IsIgnoringStopOnInteraction() { return false; }
