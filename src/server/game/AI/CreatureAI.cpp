...
void CreatureAI::MoveInLineOfSight(Unit* who)
{
    ...
    if (me->canStartAttack(who, false))
    {
        ...
        {
            if (Creature* creatureVehicle = vehicle->GetBase()->ToCreature())
                if (creatureVehicle->IsValidAttackTarget(who) && creatureVehicle->canStartAttack(who, true))
                    creatureVehicle->AI()->AttackStart(who);
        }
    }
