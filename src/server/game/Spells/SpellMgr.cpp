...
void SpellMgr::LoadSpellCustomAttr()
{
    ...
    for (uint32 i = 0; i < GetSpellInfoStoreSize(); ++i)
    {
        ...
        case 28375: // Decimate - Gluth (Naxxramas)
            ...
            break;
        case 64801: // Gift of Earth Mother Rejuvenation instant healing.
        case 52759: // Ancestral Awakening Healing
...
void SpellMgr::LoadSpellInfoCorrections()
{
    ...
    for (uint32 i = 0; i < mSpellInfoMap.size(); ++i)
    {
		...
		case 73532: // testing
			...
			spellInfo->Effects[EFFECT_1].MiscValue = 39152;
			spellInfo->Effects[EFFECT_0].MiscValue = 39152;
            break;
        ...
        case 42835: // Spout, remove damage effect, only anim is needed
            ...
            break;
        case 98085: // Flame Protection Rune Burst, shouldn't do damanage according to retail: https://www.youtube.com/watch?v=S_YFfWDn6sM
            spellInfo->Effects[EFFECT_0].Effect = 0; // remove damage effect
            break;
        case 30657: // Quake
        ...
        case 54836: // Wrath of the Plaguebringer
            ...
            break;
        case 81269: // Efflorescence triggered heal
            spellInfo->AttributesEx2 |= SPELL_ATTR2_CAN_TARGET_NOT_IN_LOS;
            break;
        case 85801: // DPS Caster Crit Damage Bonus (Passive)
            spellInfo->Effects[EFFECT_0].BasePoints = 100;
            break;
        case 61922: // Sprint (waterwalk)
        ...
        case 68182: // Shatter Rubble - For Quest: Deep Impact, now targets gameobject and not self / npc
            ...
            break;
        case 69847: // Warstomp, for quest: War Dance
            spellInfo->AttributesEx |= SPELL_ATTR1_CANT_TARGET_SELF;
            break;
        case 78499: // For quest: Striking Back
            spellInfo->AttributesEx |= SPELL_ATTR1_CANT_TARGET_SELF;
            break;
        ...
        case 62012: // Turkey Caller
            ...
            break;
        case 71898: // Water Pitcher for quest: Last Rites, First Rites. Prevent spawning above ground. 
                    // https://project-nightfall.org/bugtracker/issue/603/%5BQuest%5D%5BLast-rites%2C-first-rites%5D-Object-is-placed-above-ground.
            spellInfo->Effects[EFFECT_2].ApplyAuraName = SPELL_AURA_DUMMY;
            break;
            // OCULUS SPELLS
        ...
        case 89130:
            ...
            break;
        case 66789: // Land Mine, fix https://project-nightfall.org/bugtracker/issue/122/%5BObject%5D-Land-Mine
            spellInfo->Effects[EFFECT_2].TargetA = TARGET_UNIT_DEST_AREA_ENTRY;
            spellInfo->Effects[EFFECT_2].RadiusEntry = sSpellRadiusStore.LookupEntry(EFFECT_RADIUS_4_YARDS);
            spellInfo->Effects[EFFECT_2].Effect = SPELL_EFFECT_KNOCK_BACK_DEST;
            spellInfo->Effects[EFFECT_2].MiscValue = 100;
        ...
        case 89821: // Hercular's Rod
            spellInfo->Effects[EFFECT_0].TargetA = TARGET_UNIT_TARGET_ANY;
            break;
        case 78395:  // Plant Ironforge Banner
            spellInfo->Effects[EFFECT_0].TargetA = TARGET_DEST_DEST_FRONT;
            spellInfo->Effects[EFFECT_0].RadiusEntry = sSpellRadiusStore.LookupEntry(EFFECT_RADIUS_2_YARDS); // Avoid the object spawning in the player which makes it stuck.
            break;
        ...
        case 94528: // Flare Trigger
            ...
            spellInfo->AttributesEx2 |= SPELL_ATTR2_CAN_TARGET_NOT_IN_LOS;
            break;
        case 19434: // Aimed Shot, should be cancelled when enemy gets within minium range of the spell.
            spellInfo->AttributesEx4 &= ~SPELL_ATTR4_IGNORE_MIN_RANGE_CHECK;
            break;
            /* End*/
            /* Druid coorections*/
            // Mainaz: Druid cat's form charge
        case 49376:
            spellInfo->AttributesEx3 |= SPELL_ATTR3_NO_INITIAL_AGGRO;
            break;
            /* End*/
        case 88611: // Mainaz: Smoke bomb
            spellInfo->Effects[EFFECT_0].RadiusEntry = sSpellRadiusStore.LookupEntry(EFFECT_RADIUS_2_YARDS); // 10yards
            spellInfo->DurationEntry = sSpellDurationStore.LookupEntry(574); // 200 ms
            break;
        case 76577: // Mainaz: Smoke bomb debuff, changing the MS for the dbc
            spellInfo->Effects[EFFECT_1].Amplitude = 10;
            break;
        case 32182: // Mainaz: Bloodlust
        case 80353: // Timewrap
        case 90355: // Ancien Hysteria(hunter)
            spellInfo->AttributesEx2 |= SPELL_ATTR2_CAN_TARGET_NOT_IN_LOS;
            break;
        ...
        case 92914:
            spellInfo->MaxAffectedTargets = 1;
            break;
        case 79205: // Chromatic Aberration jump down
            spellInfo->Effects[EFFECT_0].TargetB = 0;
            break;
        ...
        case 84638:
            ...
            spellInfo->AttributesEx &= ~SPELL_ATTR1_CANT_TARGET_SELF;
            break;
        case 79450: // For quest: Feeding the Hungry and The Hopeless. The gameobject/summon now spawns at ground-level instead of above ground.
            spellInfo->Effects[EFFECT_1].ApplyAuraName = SPELL_AURA_DUMMY;
            break;
        case 38439: // For quest: Kindness. The gameobject now spawns at ground-level instead of above ground and avoid spawning exactly at the caster.
            spellInfo->Effects[EFFECT_0].ApplyAuraName = SPELL_AURA_DUMMY;
            spellInfo->Effects[EFFECT_0].TargetA = TARGET_DEST_DEST_FRONT;
            spellInfo->Effects[EFFECT_0].RadiusEntry = sSpellRadiusStore.LookupEntry(EFFECT_RADIUS_3_YARDS); // Avoid the object spawning in the player which makes it stuck.
            break;
        case 35246: // For quest: Surveying the Ruins. The gameobject now spawns at ground-level instead of above ground and avoid spawning exactly at the caster.
            spellInfo->Effects[EFFECT_2].ApplyAuraName = SPELL_AURA_DUMMY;
            break;
        case 68213: // Weed Whacker, range
            spellInfo->Effects[EFFECT_1].RadiusEntry = sSpellRadiusStore.LookupEntry(EFFECT_RADIUS_5_YARDS); // Meele hits, increase the range.
            break;                                                                              // Burning Orbs
        case 98565: // Burning Orbs
        ...
        case 89668: // Lighting Rod
            spellInfo->MaxAffectedTargets = 1;
            break;
        case 83968: // Guild Mass Resurrect
            spellInfo->AttributesEx2 |= SPELL_ATTR2_CAN_TARGET_DEAD;
            spellInfo->AttributesEx8 |= SPELL_ATTR8_CANT_MISS; // eg. before, if the resser is lower level than the death person, it will most likely miss
            break;
        case 82170:
            spellInfo->Effects[EFFECT_2].BasePoints = 0;
            break;
        ...
        case 96724:
            spellInfo->AttributesEx3 |= SPELL_ATTR3_IGNORE_HIT_RESULT;
            break;
        case 93564: // Pistol Barrage damage nerf
        ...
        case 100294:
            spellInfo->AttributesEx4 |= SPELL_ATTR4_TRIGGERED;
            break;
        case 99411: // Leech Venom HACK - should only hit beth but TARGET_UNIT_NEARBY_ENTRY dont work with conditions and spellscript...
            spellInfo->Effects[EFFECT_0].TargetA = TARGET_UNIT_CASTER;
            spellInfo->Effects[EFFECT_0].TargetB = TARGET_UNIT_TARGET_ANY;
            break;
        case 38022: // Fel and the Furious, some hacks to make it better visually.
            spellInfo->Effects[EFFECT_0].TargetA = TARGET_UNIT_TARGET_ANY;
            spellInfo->Effects[EFFECT_1].TargetA = TARGET_UNIT_TARGET_ANY;
            spellInfo->Effects[EFFECT_2].TargetA = TARGET_UNIT_TARGET_ANY;
        ...
        case 75763: // Umbral Mending
            spellInfo->Effects[0].RadiusEntry = sSpellRadiusStore.LookupEntry(28);
            break;
        case 74669: // Blitz Summon
        case 74639: // Grounding Siege Summon
            spellInfo->Effects[EFFECT_0].TargetB = 0;
            break;
        ...
        case 76164: // Shadow of Obsidius
            ...
            break;
            ////////////////////////////
            // End of Blackrock Caverns Spells//
            ////////////////////////////
            ////////////////////////////
        ...
        case 84913: // Lava Seed
            ...
            break;
            ////////////////////////////
            // End of Bastion of Twilight spells//////
            ////////////////////////////
            ////////////////////////////
            // Dragon  Soul spells//////
            ////////////////////////////
        ...
        case 37834:
            spellInfo->Attributes |= SPELL_ATTR0_UNAFFECTED_BY_INVULNERABILITY;
            break;
            // Defias Reaper spells - dont know why this vehicle is immune to everything...
        case 91731:
        case 91737:
        case 91738:
            spellInfo->AttributesEx3 |= SPELL_ATTR3_IGNORE_HIT_RESULT;
