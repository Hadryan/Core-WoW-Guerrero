...
namespace SpellResults
{
    enum SpellPrepareResults
    {
        Ok,
        Queued,
        Failed,
...
class Spell
{
    ...
    public:
        ...
        SpellResults::SpellPrepareResults prepare(SpellCastTargets const* targets, AuraEffect const* triggeredByAura = nullptr, uint32 p_GcdAtCast = 0);
