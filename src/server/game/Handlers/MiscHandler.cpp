...
void WorldSession::HandleLogoutRequestOpcode(WorldPacket& /*recvData*/)
{
    ...
    else if (GetPlayer()->duel || GetPlayer()->InArena() || GetPlayer()->HasAura(9454)) ///< is dueling, in arena or frozen by GM via freeze command
...
void WorldSession::HandleSetActionBarToggles(WorldPacket& recvData)
{
    ...
    if (GetPlayer()->GetPet())
    {
        if (GetPlayer()->getClass() == CLASS_WARLOCK || GetPlayer()->getClass() == CLASS_HUNTER)
            if (GetPlayer()->HasSpell(80388) || GetPlayer()->HasSpell(93321)) // Control Demon/Pet
