...
#ifndef monster_OBJECTACCESSOR_H
#define monster_OBJECTACCESSOR_H
...
class HashMapHolder
{
    public:
        ...
        {
            monster_WRITE_GUARD(LockType, i_lock);
        ...
        {
            monster_READ_GUARD(LockType, i_lock);
...
class ObjectAccessor
{
    ...
    public:
        ...
        template<class T> static T* GetObjectInWorld(uint32 mapid, float x, float y, uint64 guid, T* /*fake*/)
        {
            ...
            CellCoord q = monster::ComputeCellCoord(obj->GetPositionX(), obj->GetPositionY());
            if (!q.IsCoordValid())
            {
        ...
        {
            monster_GUARD(ACE_Thread_Mutex, i_objectLock);
