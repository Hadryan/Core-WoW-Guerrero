...
#ifndef monster_SHAREDDEFINES_H
#define monster_SHAREDDEFINES_H
...
enum SpellAttr4
{
    ...
    SPELL_ATTR4_IGNORE_MIN_RANGE_CHECK           = 0x10000000, // 28 Aimed Shot only, spells with this attribute prevents the client from sending CMSG_CANCEL_CAST when a creature gets minimum casting range of the spell.
...
enum SpellAttr5
{
	SPELL_ATTR5_CAN_CHANNEL_WHILE_MOVING         = 0x00000001, //  0
