...
class WorldSession
{
    public:
        ...
        void SendTrainerList(uint64 guid, uint32 index = 0);
        void SendTrainerList(uint64 guid, std::string const& strTitle, uint32 index = 0);
        ...
        const char *GetmonsterString(int32 entry) const;
    ...
    public:                                                 // opcodes handlers
        ...
        void SetStabilityTest(bool p_Value) { m_IsStabilityTestSession = p_Value; }
