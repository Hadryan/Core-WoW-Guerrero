...
#ifndef monster_MAP_H
#define monster_MAP_H
...
class MapInstanced;
class InstanceMap;
namespace monster { struct ObjectUpdater; }
...
class Map : public GridRefManager<NGridType>
{
    ...
    public:
        ...
        void VisitNearbyCellsOf(WorldObject* obj, TypeContainerVisitor<monster::ObjectUpdater, GridTypeMapContainer> &gridVisitor, TypeContainerVisitor<monster::ObjectUpdater, WorldTypeMapContainer> &worldVisitor);
        ...
        {
            return IsGridLoaded(monster::ComputeGridCoord(x, y));
        }
        ...
        //////////////////////////////////////////////////////////////////////////
        /// MapScripts SAI Support :) by Artamedes (Jesus)
        //////////////////////////////////////////////////////////////////////////

        /// Call it when you want your script type to start
        /// @p_Type - SmartScriptType of script, supported: SMART_SCRIPT_TYPE_EVENT, SMART_SCRIPT_TYPE_SPELL, SMART_SCRIPT_TYPE_WAYPOINT
        /// @p_Entry - Identifier ID, EventID || SpellID || WaypointID
        /// @p_Source - Source unit
        /// @p_Target - Target unit (Used in spell scripts)
        void ScriptsStart(SmartScriptType p_Type, uint32 p_Entry, Object* p_Source, Object* p_Target, uint32 p_EffIndex = 0);

        /// Update all scripts.
        /// Called in Map::Update
        /// @p_Diff - difftime passed
        void ScriptsProcess(const uint32 p_Diff);
        ...
        TempSummon* SummonCreature(uint32 entry, Position const& pos, SummonPropertiesEntry const* properties = NULL, uint32 duration = 0, WorldObject* summoner = NULL, uint32 spellId = 0, uint32 vehId = 0, bool visibleOnlyBySummoner = false);
    ...
    private:
        ...
        NGridType* getNGrid(uint32 x, uint32 y) const
        {
            ...
            {
//                TC_LOG_ERROR("general", "CRASH::map::setNGrid() Invalid grid coordinates found: %d, %d!", x, y);
                return NULL;
            }
            return i_grids[x][y];
        }
    ...
    private:
        ...
        typedef std::multimap<uint32, SmartScript*> ScriptScheduleMapSAI;
        ScriptScheduleMapSAI m_scriptScheduleSAI;
