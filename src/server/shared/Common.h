...
enum AccountTypes
{
	...
	SEC_GAMEMASTER        = 2,
	SEC_GAMEMASTER_II     = 3,
	SEC_GAMEMASTER_III    = 4,
	SEC_GAMEMASTER_IV     = 5,
	SEC_GAMEMASTER_V      = 6,
	SEC_GAMEMASTER_VI     = 7,
	SEC_GAMEMASTER_VII    = 8,
	SEC_MODERATOR_II      = 9,
	SEC_ADMINISTRATOR     = 10,
	SEC_CONSOLE           = 11,                                 // must be always last in list, accounts must have less security level always also
	SEC_OWNER             = 255                                // must be always last in list, accounts must have less security level always also
};
