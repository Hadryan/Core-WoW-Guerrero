...
#ifndef _monster_REALM_CONFIG
# define _monster_REALM_CONFIG  "authserver.conf"
#endif
...
class AuthServerSignalHandler : public monster::SignalHandler
{
public:
...
extern int main(int argc, char **argv)
{
    ...
    char const* cfg_file = _monster_REALM_CONFIG;
    int c = 1;
    while (c < argc)
    {
