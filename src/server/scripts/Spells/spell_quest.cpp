...
enum RedSnapperVeryTasty
{
    ...
    // SPELL_NEW_SUMMON_TEST   = 49214, // Bugs very odd when summoning through the spell. Lets summon it manually instead.
        ...
        class spell_q9452_cast_net_SpellScript : public SpellScript
        {
            ...
            void HandleDummy(SpellEffIndex /*effIndex*/)
            {
                ...
                if (roll_chance_i(66))
                    ...
                    if (Creature* pMurloc = caster->SummonCreature(NPC_ANGRY_MURLOC, caster->GetPositionX(), caster->GetPositionY() + 20.0f, caster->GetPositionZ(), 0.0f, TEMPSUMMON_CORPSE_TIMED_DESPAWN, 10000))
                        pMurloc->AI()->AttackStart(caster);
            }
    ...
    public:
        ...
        class spell_q11010_q11102_q11023_choose_loc_SpellScript : public SpellScript
        {
            ...
            void HandleDummy(SpellEffIndex /*effIndex*/)
            {
                ...
                monster::AnyPlayerInObjectRangeCheck checker(caster, 65.0f);
                monster::PlayerListSearcher<monster::AnyPlayerInObjectRangeCheck> searcher(caster, playerList, checker);
...
{
    new spell_q55_sacred_cleansing(); // Verified
	new spell_q5206_test_fetid_skull(); // Verified
	new spell_q6124_6129_apply_salve(); // Verified
	new spell_q10255_administer_antidote(); // Verified
	new spell_q11396_11399_force_shield_arcane_purple_x3(); // Verified
	new spell_q11396_11399_scourging_crystal_controller(); // Verified
	new spell_q11396_11399_scourging_crystal_controller_dummy(); // Verified
	new spell_q11515_fel_siphon_dummy(); // Verified
	new spell_q11587_arcane_prisoner_rescue(); // Verified
	new spell_q11730_ultrasonic_screwdriver(); // Verified
	new spell_q12459_seeds_of_natures_wrath(); // Verified
	new spell_q12634_despawn_fruit_tosser(); // Verified
	new spell_q12683_take_sputum_sample(); // Verified
	new spell_q12851_going_bearback(); // Verified
	new spell_q12937_relief_for_the_fallen(); // Verified
	new spell_q10041_q10040_who_are_they(); // Verified
	new spell_symbol_of_life_dummy(); // Verified
	new spell_q12659_ahunaes_knife(); // Verified
	new spell_q9874_liquid_fire(); // Verified
	new spell_q12805_lifeblood_dummy(); // Verified
	new spell_q13280_13283_plant_battle_standard(); // Verified
	new spell_q14112_14145_chum_the_water(); // Verified
	new spell_q9452_cast_net(); // Verified
	new spell_q12987_read_pronouncement(); // Verified
	new spell_q12277_wintergarde_mine_explosion(); // Verified
	new spell_q12066_bunny_kill_credit(); // Verified
	new spell_q12735_song_of_cleansing(); // Verified
	new spell_q12372_cast_from_gossip_trigger(); // Verified
	new spell_q12372_destabilize_azure_dragonshrine_dummy(); // Verified
	new spell_q11010_q11102_q11023_aggro_check_aura(); // Verified
	new spell_q11010_q11102_q11023_aggro_check(); // Verified
	new spell_q11010_q11102_q11023_aggro_burst(); // Verified
	new spell_q11010_q11102_q11023_choose_loc(); // Verified
	new spell_q11010_q11102_q11023_q11008_check_fly_mount(); // Verified
	new spell_q12372_azure_on_death_force_whisper(); // Verified
	new spell_q12527_zuldrak_rat(); // Verified
    new spell_q25154_q25160(); // Recently Verified
    new spell_q25105_q25158(); // Recently Verified
    new spell_q25155_q25161(); // Recently Verified
    new spell_q25159_stardust_no_2(); // Recently Verified
    new spell_q28138_human_infestation(); // Recently Verified
    new spell_quest29361(); // Recently Verified. (Should) be the right spell (ids)
    new SpellScriptLoaderEx<spell_quest29307_SpellScript>("spell_quest29307"); // Recently Verified, BUT no idea if it's the correct spell id??
}
