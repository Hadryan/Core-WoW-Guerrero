...
public:
    ...
    class spell_dk_rune_strike_proc_AuraScript : public AuraScript
    {
        ...
        void Register()
        {
            AfterEffectApply += AuraEffectApplyFn(spell_dk_rune_strike_proc_AuraScript::HandleEffectApply, EFFECT_0, SPELL_AURA_DUMMY, AURA_EFFECT_HANDLE_REAL_OR_REAPPLY_MASK);
            AfterEffectRemove += AuraEffectRemoveFn(spell_dk_rune_strike_proc_AuraScript::HandleEffectRemove, EFFECT_0, SPELL_AURA_DUMMY, AURA_EFFECT_HANDLE_REAL_OR_REAPPLY_MASK);
        }
    };
...
void AddSC_deathknight_spell_scripts()
{
    ...
    new spell_dk_blood_presence(); // Verified
    new spell_dk_rune_strike_proc(); // Verified
}