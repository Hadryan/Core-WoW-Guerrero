        ...
        struct npc_simon_bunnyAI : public ScriptedAI
        {
            ...
            */
            void StartGame()
            {
                ...
                monster::AllWorldObjectsInRange objects(me, searchDistance);
                monster::WorldObjectListSearcher<monster::AllWorldObjectsInRange> searcher(me, ClusterList, objects);
