...
class go_ally : public GameObjectScript
{
public:
    go_ally() : GameObjectScript("go_ally") { }
    ...
    bool OnGossipHello(Player* player, GameObject* go)
    {
        ...
        if (player)
        player->KilledMonsterCredit(194464, 0);
...
class go_horde : public GameObjectScript
{
public:
    go_horde() : GameObjectScript("go_horde") { }
    ...
    bool OnGossipHello(Player* player, GameObject* go)
    {
        ...
        if (player)
        player->KilledMonsterCredit(194612, 0);
