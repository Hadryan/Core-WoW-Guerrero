...
public:
    ...
    {
		return new boss_princess_theradrasAI(creature);
    }

	struct boss_princess_theradrasAI : public BossAI
    {
		boss_princess_theradrasAI(Creature* creature) : BossAI(creature, DATA_PRINCESS_THERADRAS) {}
