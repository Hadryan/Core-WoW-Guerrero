...
class boss_archaedas : public CreatureScript
{
    public:
        ...
        {
			boss_archaedasAI(Creature* creature) : BossAI(creature, DATA_ARCHAEDAS)
            {
            ...
            void ActivateMinion(uint64 uiGuid, bool flag)
            {
                ...
                if (minion && minion->isAlive())
                {
					...
					minion->RemoveFlag(UNIT_FIELD_FLAGS, UNIT_FLAG_NON_ATTACKABLE | UNIT_FLAG_NOT_SELECTABLE | UNIT_FLAG_PACIFIED | UNIT_FLAG_DISABLE_MOVE);
            ...
            {
                me->setFaction(14);
				me->RemoveFlag(UNIT_FIELD_FLAGS, UNIT_FLAG_NON_ATTACKABLE | UNIT_FLAG_NOT_SELECTABLE | UNIT_FLAG_PACIFIED | UNIT_FLAG_DISABLE_MOVE);
            }
