            ...
            void OnCreatureCreate(Creature* creature) override
            {
                switch (creature->GetEntry())
                {
                    ...
                    case NPC_MAJORDOMO_EXECUTUS:
                        ...
                        break;
					case FLAMEWAKER_PROTECTOR:  
						_flamawakerGUID = creature->GetGUID();
						break;
					case NPC_RAGNAROS:
            ...
            {     
				...
				case DATA_RAGNAROS_ADDS:
					if (data == 1)
						...
						_ragnarosAddDeaths = 0;
					break;
				case DATA_RAGNAROS_ACTIVE:
					if (data == 0)
					_ragnarosActive = true;
					else
					if (data == 1)
					_ragnarosActive = false;
					break;
