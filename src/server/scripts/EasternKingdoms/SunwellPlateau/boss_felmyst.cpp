...
public:
    ...
    struct boss_felmystAI : public ScriptedAI
    {
        ...
        void DespawnSummons(uint32 entry)
        {
            ...
            monster::AllCreaturesOfEntryInRange check(me, entry, 100);
            monster::CreatureListSearcher<monster::AllCreaturesOfEntryInRange> searcher(me, templist, check);
            TypeContainerVisitor<monster::CreatureListSearcher<monster::AllCreaturesOfEntryInRange>, GridTypeMapContainer> cSearcher(searcher);
