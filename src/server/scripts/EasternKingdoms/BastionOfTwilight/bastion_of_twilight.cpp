...
enum Events
{
    ...
    EVENT_VALIONA_THERALION_DLG_1 = 114, // INTRO
    EVENT_VALIONA_THERALION_DLG_2 = 115, // DEATH
    ...
    EVENT_VALIONA_INTRO_1         = 120,
    EVENT_VALIONA_INTRO_2         = 121,
    EVENT_THERALION_INTRO_1       = 122,
    EVENT_THERALION_INTRO_2       = 123,
};
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        ...
                        case EVENT_VALIONA_THERALION_DLG_1:
                            ...
                            events.ScheduleEvent(EVENT_THERALION_INTRO_1, 10000);
                            events.ScheduleEvent(EVENT_VALIONA_INTRO_2, 16000);
                            events.ScheduleEvent(EVENT_THERALION_INTRO_2, 21000);
                        ...
                        case EVENT_VALIONA_INTRO_1:
                            if (Creature* valiona = ObjectAccessor::GetCreature(*me, instance->GetData64(DATA_VALIONA)))
                                valiona->AI()->DoAction(ACTION_VALIONA_INTRO_1);
                            me->SetVisible(false);
                            break;
                        case EVENT_VALIONA_INTRO_2:
                            if (Creature* valiona = ObjectAccessor::GetCreature(*me, instance->GetData64(DATA_VALIONA)))
                                valiona->AI()->DoAction(ACTION_VALIONA_INTRO_2);
                            break;
                        case EVENT_THERALION_INTRO_1:
                            if (Creature* theralion = ObjectAccessor::GetCreature(*me, instance->GetData64(DATA_THERALION)))
                                theralion->AI()->DoAction(ACTION_THERALION_INTRO_1);
                            break;
                        case EVENT_THERALION_INTRO_2:
                            if (Creature* theralion = ObjectAccessor::GetCreature(*me, instance->GetData64(DATA_THERALION)))
                                theralion->AI()->DoAction(ACTION_THERALION_INTRO_2);
                            break;
                        case EVENT_VALIONA_THERALION_DLG_2: // Not seem in retail instance runs?
                            Talk(SAY_CHOGALL_9);
                            me->DespawnOrUnsummon(10000);
                            break;
    ...
    public:
        ...
        bool OnTrigger(Player* player, const AreaTriggerEntry* /*trigger*/) override
        {
            if (InstanceScript* instance = player->GetInstanceScript())
            {
                ...
                {
                    if (Creature* pChogall    = player->SummonCreature(NPC_CHOGALL_DLG,
                        player->GetPositionX(), player->GetPositionY(), player->GetPositionZ(), 1.62f))
    ...
    public:
        ...
        bool OnTrigger(Player* player, const AreaTriggerEntry* /*trigger*/) override
        {
            if (InstanceScript* instance = player->GetInstanceScript())
            {
                ...
                {
                    if (Creature* pChogall    = player->SummonCreature(NPC_CHOGALL_DLG,
                        player->GetPositionX(), player->GetPositionY(), player->GetPositionZ(), 3.16f))
    ...
    public:
        ...
        bool OnTrigger(Player* player, const AreaTriggerEntry* /*trigger*/) override
        {
            if (InstanceScript* instance = player->GetInstanceScript())
            {
                ...
                {
                    if (Creature* pChogall    = player->SummonCreature(NPC_CHOGALL_DLG,
                        player->GetPositionX(), player->GetPositionY(), player->GetPositionZ(), 4.78f))
    ...
    public:
        ...
        bool OnTrigger(Player* player, const AreaTriggerEntry* /*trigger*/) override
        {
            if (InstanceScript* instance = player->GetInstanceScript())
            {
                ...
                {
                    if (Creature* pChogall = ObjectAccessor::GetCreature(*player, instance->GetData64(DATA_CHOGALL)))
