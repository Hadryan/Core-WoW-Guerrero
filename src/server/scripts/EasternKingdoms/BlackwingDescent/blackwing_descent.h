/*
* Copyright (C) 2010-2011 Project monster <http://www.projectmonster.org/>
*
...
enum Data
{
    ...
    DATA_IS_AIR_PHASE            = 21,

    DATA_NEFARIAN_ELEVATOR       = 22,

    DATA_NEFARIAN_ELEVATOR_GUID  = 23,

    DATA_NEFARIOUS_INSTANCE_INTRO_STATE = 24,
    DATA_NEFARIOUS_OMNONTRON_INTRO_STATE = 25,
    DATA_NEFARIOUS_MALORIAK_INTRO_STATE = 26,
    DATA_NEFARIOUS_ATRAMEDES_INTRO_STATE = 27,
...
enum Creatures
{
    ...
    NPC_INTRO_NEFARIAN_ATRAMEDES= 43396,
