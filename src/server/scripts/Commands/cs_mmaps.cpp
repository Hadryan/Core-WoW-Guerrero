...
public:
    ...
    static bool HandleMmapTestArea(ChatHandler* handler, char const* /*args*/)
    {
        ...
        CellCoord pair(monster::ComputeCellCoord(object->GetPositionX(), object->GetPositionY()));
        Cell cell(pair);
        cell.SetNoCreate();

        std::list<Creature*> creatureList;

        monster::AnyUnitInObjectRangeCheck go_check(object, radius);
        monster::CreatureListSearcher<monster::AnyUnitInObjectRangeCheck> go_search(object, creatureList, go_check);
        TypeContainerVisitor<monster::CreatureListSearcher<monster::AnyUnitInObjectRangeCheck>, GridTypeMapContainer> go_visit(go_search);
